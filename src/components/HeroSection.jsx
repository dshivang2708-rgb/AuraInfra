  ...
  return (
    <section className="relative w-full h-screen flex flex-col overflow-hidden font-sans">
      ...
      <main className="relative z-10 flex-grow flex flex-col justify-center px-6 md:px-12 max-w-7xl mx-auto w-full pb-4 md:pb-6 pt-0 min-h-0">
        ...
        {/* Search bar */}
        <div className="mt-16 bg-white rounded-2xl shadow-2xl p-3 md:p-2 flex flex-col md:flex-row items-stretch md:items-center space-y-3 md:space-y-0 md:space-x-2 w-full max-w-5xl border border-gray-100">
          <div className="flex-1 px-4 py-2 md:border-r border-gray-100 flex items-center space-x-3">
            ...
            <div className="flex flex-col w-full">
              ...
              <select className="bg-transparent border-none p-0 text-sm font-bold text-gray-800 focus:ring-0 cursor-pointer">
                <option>Sector 82, Mohali</option>
              </select>
            </div>
          </div>
          ...
          <button className="bg-brand-green hover:bg-brand-green-dark text-white px-8 py-3 rounded-xl flex items-center justify-center space-x-2 transition-colors">
            <SearchIcon />
